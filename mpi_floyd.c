...
aniket@aniket-inspiron-3542:~/Desktop$ mpiexec -n <number of processes> ./mpi_floyd
bash: number: No such file or directory
aniket@aniket-inspiron-3542:~/Desktop$ mpicc -g -Wall -o mpi_floyd mpi_floyd.c
aniket@aniket-inspiron-3542:~/Desktop$ ./mpi_floyd
